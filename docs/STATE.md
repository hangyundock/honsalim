...
| 영역 | 값 | 최종 확인 세션 |
|------|----|---------------|
| 진행 단계 | **Phase 1 ~95% + Phase 2 핵심 모듈 12개·회귀 232 PASS + CLI 8 명령** [확정] | #4 (2026-05-28) |
...
| Phase 2 회귀 테스트 | **232/232 PASS** [확정] — validator 39 + state_machine 14 + scenario_loader 11 + enricher 13 + meta_extractor 31 + jsonld 45 + db 12 + cli 31 + article_writer 25 + integration_phase2 11 (10 test 파일) | #4 |
